...
// Округляет decimal до ближ. целого числа в сторону отрицательной бесконечности
...
int s21_floor(s21_decimal value, s21_decimal* result) {
  ...
  // если число отрицательное и дробная часть > 0
  if (sign && !s21_is_equal(value_frac, s21_decimal_get_zero())) {
