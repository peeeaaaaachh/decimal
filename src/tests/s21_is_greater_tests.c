...
START_TEST(positive_32_bit_a_is_greater_then_positive_32_bit_b) {
  // a > b
...
START_TEST(positive_32_bit_b_is_greater_then_positive_32_bit_a) {
  // a < b
  s21_decimal a = {.bits = {456, 0, 0, 0}};
...
START_TEST(negative_32_bit_a_is_greater_then_positive_32_bit_b) {
...
START_TEST(negative_32_bit_b_is_greater_then_positive_32_bit_a) {
...
START_TEST(negative_32_bit_a_is_greater_then_negative_32_bit_b) {
...
START_TEST(negative_32_bit_b_is_greater_then_negative_32_bit_a) {
  // -b > -a? -235 > -654? Да
  s21_decimal a = {.bits = {654, 0, 0, 0x80000000U}};
  s21_decimal b = {.bits = {235, 0, 0, 0x80000000U}};

  int result = s21_is_greater(b, a);
  ck_assert_int_eq(result, 1);
}
END_TEST;
...
START_TEST(positive_64_bit_a_is_greater_then_positive_64_bit_b) {
  // a > b
...
START_TEST(positive_64_bit_b_is_greater_then_positive_64_bit_a) {
  // a < b
...
START_TEST(negative_64_bit_a_is_greater_then_positive_64_bit_b) {
  // -a > b? Нет
...
START_TEST(negative_64_bit_b_is_greater_then_positive_64_bit_a) {
  // a > -b? Да
...
START_TEST(negative_64_bit_a_is_greater_then_negative_64_bit_b) {
  // -a > -b? -654 > -235? Нет
...
START_TEST(negative_64_bit_b_is_greater_then_negative_64_bit_a) {
  // -b > -a? -235 > -654? Да
  s21_decimal a = {.bits = {654, 6475, 0, 0x80000000U}};
  s21_decimal b = {.bits = {235, 5178, 0, 0x80000000U}};
...
START_TEST(positive_96_bit_a_is_greater_then_positive_96_bit_b) {
  // a > b
...
START_TEST(positive_96_bit_b_is_greater_then_positive_96_bit_a) {
  // a < b
...
START_TEST(negative_96_bit_a_is_greater_then_positive_96_bit_b) {
  // -a > b? Нет
...
START_TEST(negative_96_bit_b_is_greater_then_positive_96_bit_a) {
  // a > -b? Да
...
START_TEST(negative_96_bit_a_is_greater_then_negative_96_bit_b) {
  // -a > -b? -654 > -235? Нет
...
START_TEST(negative_96_bit_b_is_greater_then_negative_96_bit_a) {
  // -b > -a? -235 > -654? Да
  s21_decimal a = {.bits = {654, 6475, 87654, 0x80000000U}};
  s21_decimal b = {.bits = {235, 5178, 12345, 0x80000000U}};
...
START_TEST(greater_with_scale_same_number) {
...
START_TEST(greater_with_different_scale) {
...
START_TEST(greater_with_scale_edge) {
...
START_TEST(greater_max_decimal_vs_max_minus_one) {
...
START_TEST(greater_min_decimal_vs_min_plus_one) {
...
START_TEST(greater_zero_with_different_scales) {
  // 0.00 vs 0.000
...
START_TEST(greater_numbers_need_normalization) {
  // Числа, которые требуют приведения к общему масштабу
  s21_decimal a = {.bits = {1, 0, 0, 0}};
  s21_decimal b = {.bits = {1, 0, 0, 28 << 16}};

  int result = s21_is_greater(a, b);
  ck_assert_int_eq(result, 1);  // 1 > очень маленького
}
END_TEST

START_TEST(greater_negative_with_scale) {
  // -1.23 vs -1.25
...
START_TEST(greater_normalization_overflow) {
  ...
  int result = s21_is_greater(a, b);
  ck_assert_int_eq(result, 1);  // огромное число > 1
}
END_TEST

START_TEST(greater_max_with_scale_vs_max) {
...
Suite* s21_is_greater_suite() {
  ...
  tcase_add_test(tc, positive_32_bit_a_is_greater_then_positive_32_bit_b);
  tcase_add_test(tc, positive_32_bit_b_is_greater_then_positive_32_bit_a);
  tcase_add_test(tc, negative_32_bit_a_is_greater_then_positive_32_bit_b);
  tcase_add_test(tc, negative_32_bit_b_is_greater_then_positive_32_bit_a);
  tcase_add_test(tc, negative_32_bit_a_is_greater_then_negative_32_bit_b);
  tcase_add_test(tc, negative_32_bit_b_is_greater_then_negative_32_bit_a);
  tcase_add_test(tc, positive_32_bit_a_equal_positive_32_bit_b);
  tcase_add_test(tc, negative_32_bit_a_equal_negative_32_bit_b);

  tcase_add_test(tc, positive_64_bit_a_is_greater_then_positive_64_bit_b);
  tcase_add_test(tc, positive_64_bit_b_is_greater_then_positive_64_bit_a);
  tcase_add_test(tc, negative_64_bit_a_is_greater_then_positive_64_bit_b);
  tcase_add_test(tc, negative_64_bit_b_is_greater_then_positive_64_bit_a);
  tcase_add_test(tc, negative_64_bit_a_is_greater_then_negative_64_bit_b);
  tcase_add_test(tc, negative_64_bit_b_is_greater_then_negative_64_bit_a);
  tcase_add_test(tc, positive_64_bit_a_equal_positive_64_bit_b);
  tcase_add_test(tc, negative_64_bit_a_equal_negative_64_bit_b);

  tcase_add_test(tc, positive_96_bit_a_is_greater_then_positive_96_bit_b);
  tcase_add_test(tc, positive_96_bit_b_is_greater_then_positive_96_bit_a);
  tcase_add_test(tc, negative_96_bit_a_is_greater_then_positive_96_bit_b);
  tcase_add_test(tc, negative_96_bit_b_is_greater_then_positive_96_bit_a);
  tcase_add_test(tc, negative_96_bit_a_is_greater_then_negative_96_bit_b);
  tcase_add_test(tc, negative_96_bit_b_is_greater_then_negative_96_bit_a);
  tcase_add_test(tc, positive_96_bit_a_equal_positive_96_bit_b);
  tcase_add_test(tc, negative_96_bit_a_equal_negative_96_bit_b);

  tcase_add_test(tc, greater_with_scale_same_number);
  tcase_add_test(tc, greater_with_different_scale);
  tcase_add_test(tc, greater_with_scale_edge);
  tcase_add_test(tc, greater_max_decimal_vs_max_minus_one);
  tcase_add_test(tc, greater_min_decimal_vs_min_plus_one);
  tcase_add_test(tc, greater_zero_with_different_scales);
  tcase_add_test(tc, greater_numbers_need_normalization);
  tcase_add_test(tc, greater_negative_with_scale);
  tcase_add_test(tc, greater_normalization_overflow);
  tcase_add_test(tc, greater_max_with_scale_vs_max);
